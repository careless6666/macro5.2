namespace MACRO_52
{
    ...
    internal class CfrmParameters : Form
    {
        ...
        private short Tab1_SelectedIndexChangedPreviousTab;
        private StaticLocalInitFlag Tab1_SelectedIndexChangedPreviousTabInit;
        ...
        public CfrmParameters(ref CfrmMain frm)
        {
            ...
            this.Tab1_SelectedIndexChangedPreviousTabInit = new StaticLocalInitFlag();
        ...
        {
            Monitor.Enter(this.Tab1_SelectedIndexChangedPreviousTabInit);
            try
            {
                if (this.Tab1_SelectedIndexChangedPreviousTabInit.State == 0)
                {
                    this.Tab1_SelectedIndexChangedPreviousTabInit.State = 2;
                    this.Tab1_SelectedIndexChangedPreviousTab = (short) this.SSTab1.SelectedIndex;
                }
                else if (this.Tab1_SelectedIndexChangedPreviousTabInit.State == 2)
                {
            ...
            {
                this.Tab1_SelectedIndexChangedPreviousTabInit.State = 1;
                Monitor.Exit(this.Tab1_SelectedIndexChangedPreviousTabInit);
            }
